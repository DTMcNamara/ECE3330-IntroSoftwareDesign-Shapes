/**
 * the Triangle class inherits from twoDimensionalShape
 * and implements the TwoDimensionalShape interface.
 * It defines all methods in such a way to represent a
 * triangle.
 */
public class Triangle extends TwoDimensionalShape implements TwoDimensionalShape.TwoDimensionalShapeInterface {

    /**
     * The blank triangle constructor
     * makes a unit triangle with
    ...
    /**
     * The triangle constructor with
     * 1 argument is used to create
     * a triangle object with the dimension1
     ...
     * a triangle with dimensions set
